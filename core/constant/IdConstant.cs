namespace AnimationEditTool_Core
{
    public static class IdConstant
    {
        ...
        /// </summary>
        public static int ID_TYPE_AnimCombination = 1;
        /// <summary>
        /// 动画组件 AnimComponent 类型
        /// </summary>
        public static int ID_TYPE_AnimComponent = 2;
        /// <summary>
        /// 动画 AnimSingle 类型
        /// </summary>
        public static int ID_TYPE_AnimSingle = 3;
        /// <summary>
        /// 动画轨道 AnimTrack 类型
        /// </summary>
        public static int ID_TYPE_AnimTrack = 4;
        /// <summary>
        /// 关键帧 TrackKeyPoint 类型
        /// </summary>
        public static int ID_TYPE_TrackKeyPoint = 5;
        //最大的需要保存的id
